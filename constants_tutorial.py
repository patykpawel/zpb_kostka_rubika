...
slices_stage00 = np.array([1, 3, 5, 7, 46, 48, 50, 52])
slices_stage01 = np.array([24, 26, 30, 32])
...
#     [24, 26, 30, 32],
# ]
slices_stage10 = np.array([0, 2, 6, 8, 45, 47, 51, 53])
slices_stage11 = np.array([1, 3, 5, 7, 46, 48, 50, 52])
slices_stage12 = np.array([24, 26, 30, 32])


slices_stage2 = [
    [0, 2, 6, 8, 45, 47, 51, 53],
    [9, 11, 33, 35, 15, 17, 39, 41],
    [12, 14, 36, 38, 18, 20, 42, 44],
    [10, 34, 16, 40],
    [13, 37, 19, 43],
]
...
available_colors_stage00 = np.array(["W", "Y"])
available_colors_stage01 = np.array(["G", "B"])

# available_colors_stage1 = [['O'], ['R'], ['W', 'B']]

# available_colors_stage1 = [["W", "Y"], ["W", "Y"], ["G", "B"]]
available_colors_stage10 = np.array(["W", "Y"])
available_colors_stage11 = np.array(["W", "Y"])
available_colors_stage12 = np.array(["G", "B"])
...
all_moves = list(set(stage0_moves + stage1_moves + stage2_moves + stage3_moves))
